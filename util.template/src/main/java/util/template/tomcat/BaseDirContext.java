...
public abstract class BaseDirContext implements DirContext {
     ...
     * @exception NameAlreadyBoundException if name is already
     * bound
     * @exception InvalidAttributesException if object
     ...
     * @exception NameAlreadyBoundException if newName is already
     * bound
     * @exception NamingException if a naming exception is encountered
     */
    @Override
     ...
     * @exception NameNotFoundException if an intermediate context does not
     * exist
     * @exception NotContextException if the name is bound but does
     ...
     * @exception NameAlreadyBoundException if name is already
     * bound
     * @exception InvalidAttributesException if creation
     ...
     * @exception OperationNotSupportedException if the naming
     ...
     * be null
     * @exception AttributeModificationException if the
     ...
     * @exception NameAlreadyBoundException if name is already
     * bound
     * @exception InvalidAttributesException if some
     ...
     * @exception NameAlreadyBoundException if name is already
     * bound
     * @exception InvalidAttributesException if attrs
     ...
     * @exception OperationNotSupportedException if schema not
     * supported
     * @exception NamingException if a naming exception is encountered
     */
    @Override
     ...
     * @exception InvalidSearchFilterException if the
     * search filter specified is not supported or understood by the underlying
     * directory
     * @exception InvalidSearchControlsException if the
     ...
     * @exception InvalidSearchControlsException if the
     * search controls contain invalid settings
     * @exception InvalidSearchFilterException if
